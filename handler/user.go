...
func (h *userHandler) Login(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Login failed, user not found", http.StatusUnprocessableEntity, "error", errorMessage)
